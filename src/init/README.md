...
| <a name="input_github_repository"></a> [github\_repository](#input\_github\_repository) | Github repository in the format organization/repository | `string` | `"pagopa/cms-pn-infra"` | no |
...
| <a name="output_github_iac_role_arn"></a> [github\_iac\_role\_arn](#output\_github\_iac\_role\_arn) | n/a |
